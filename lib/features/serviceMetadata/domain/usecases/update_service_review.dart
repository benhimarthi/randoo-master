...
class UpdateServiceReview
    extends UseCaseWithParam<void, UpdateServiceReviewParams> {
  final ServiceMetadataRepository repository;

  UpdateServiceReview(this.repository);

  @override
  ResultVoid call(UpdateServiceReviewParams params) => repository
      .updateServiceReview(serviceId: params.serviceId, rating: params.rating);
}
